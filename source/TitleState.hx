...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		trace('This is an official build');
		if (!closedState)
		{
			trace('checking for update');
			var http = new haxe.Http("https://raw.githubusercontent.com/FuroYT/FNF-VS-Doflanico/main/updateShit.txt");
	...
	override function update(elapsed:Float)
	{
		...
		{
			trace("No you can't skip the intro");
			//skipIntro();
		}
	...
	override function beatHit()
	{
		...
		if (!closedState)
		{
			...
			switch (sickBeats)
			{
				...
				case 15:
					addMoreText('This intro');
				case 16:
					addMoreText('Is Very');
				case 18:
					addMoreText('Longggggggg');
				case 20:
					deleteCoolText();
				case 22:
					addMoreText('Mod coded by');
				case 24:
					addMoreText('Furo');
				case 26:
					deleteCoolText();
				...
				case 32:
					addMoreText("Doflanico"); // credTextShit.text += '\nFunkin';
