...
class ChartingState extends MusicBeatState
{
	...
	var eventStuff:Array<Dynamic> = [
		...
		[
			'Sway that shit',
			"Sways the camera left then right then left then- \n\n Value1: Sways Game Camera\n Value2: Sways HUD\n Every value works the same with the same format, example: \n \"1, 1, 30\" will give a sway of 1 second, at speed 1, and with max angle 30 degrees in either direction"
		],
		[
			'Turn on cam zooming',
		 	""
