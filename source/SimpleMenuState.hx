...
class SimpleMenuState extends MusicBeatState
{
	...
	function openSelectedSubstate(label:String)
	{
		switch (label)
		{
			...
			case 'Discord':
				CoolUtil.browserLoad('https://discord.gg/crTNEkFbjD');
			case 'Twitter':
				CoolUtil.browserLoad('https://twitter.com/FNF_Doflanico');
			case 'Options':
	...
	override function create()
	{
		...
		#if !debug
		versionShit.text = "Dofla Engine v" + MainMenuState.beatEngineVersion;
		#end
		#if debug
		versionShit.text = "Dofla Engine v" + MainMenuState.beatEngineVersion + ' (debug)';
		#end
		versionShitpsych.text = "Friday Night Funkin' VS Doflanico " + MainMenuState.modVer;
