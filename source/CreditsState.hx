...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [
			...
			['VS Doflanico Team Dev'],
			[
				'Furo',
				'furo',
				'Programmer',
				'https://twitter.com/furoyt_',
				'4494E6'
			],
			[
				'Dylan1399Y',
				'dylan',
				'Artist of the mod',
				'https://www.youtube.com/channel/UCyWn8i4ZyDFmBDwo9tQN9bw',
				'53E52C'
			],
			[
				'FallThox',
			...
			[
				...
				'amogus',
				'She loves impostors',
				'https://www.youtube.com/channel/UCmD8leHa9gfdUE5GoZ_uBTA',
				'53E52C'
			],
			[
				'Toika',
				'toika',
				'Charter',
				'https://www.youtube.com/channel/UCIqo1w2SHJACsHOFHAPGseg',
				'2277ff'
			],
			[
				'Kirixz',
				'kirixz',
				'Second coder',
				'https://www.youtube.com/channel/UCGbinZRgVi-mwq-mG-LkFiw',
				'61536A'
			],
			[
				'NASS Game',
				'nass',
				'Stage',
				'https://www.youtube.com/channel/UCjlBIXnSodWE9YjHIsR6HhQ',
				'206694',
			],
			[
				'Carl',
