...
class MainMenuState extends MusicBeatState
{
	...
	public static var modVer:String = 'Demo';
	public static var beatEngineVersion:String = '0.5.0'; // this is used for Discord RPC
	public static var beatEngineGit:String = '0.5.0';
	...
	override function create()
	{
		...
		#if !debug
		versionShit.text = "Dofla Engine v" + beatEngineVersion;
		#end
		#if debug
		versionShit.text = "Dofla Engine v" + beatEngineVersion + ' (debug)';
		#end
		versionShitpsych.text = "Friday Night Funkin' VS Doflanico " + modVer;
